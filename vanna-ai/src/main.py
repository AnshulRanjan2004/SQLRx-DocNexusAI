...
def main():
    ...
    if "user_name" not in st.session_state or not st.session_state.user_name:
        caption_placeholder.caption("🚀 A streamlit chatbot for NLP to SQL")
        ...
        if submit_button and user_name:
            ...
            caption_placeholder.caption(f"🚀 Hi {st.session_state.user_avatar} {st.session_state.user_name}, welcome to the streamlit chatbot for NLP to SQL")
